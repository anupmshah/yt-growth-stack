...
export function RealtimeVoiceWorkspace() {
  ...
  return <main className={styles.shell}><div className={styles.workspace}>
  ...
  <section className={styles.outliers}><h3>Competitor outliers</h3><p>Illustrative rowsÃ¢â‚¬â€live evidence replaces these after a research run.</p><div><article><span><strong>I Replaced My Content Team With AI Agents</strong><small>Future Builder</small></span><b>1.2M <em>8.4x</em></b></article><article><span><strong>The AI Workflow Nobody Is Talking About</strong><small>Creator Systems</small></span><b>684K <em>6.1x</em></b></article><article><span><strong>Build Your Personal AI Operating System</strong><small>Modern Operator</small></span><b>421K <em>4.7x</em></b></article></div></section>
  <section className={styles.ideaPreview}><Lightbulb size={18}/><div><strong>Ideas worth testing</strong><p>Generated from retrieved evidenceÃ¢â‚¬â€not generic prompts.</p></div></section>
</aside>
  </div></main>;
}
