...
export const realtimeTools = [
  ...
  { type: "function", name: "create_research", description: "Propose bounded YouTube or web research for user approval. Apify defaults to 10 videos and accepts at most 25 channels/500 videos; Firecrawl accepts at most 100 URLs.", parameters: { type: "object", properties: { provider: { enum: ["apify", "firecrawl"] }, channels: { type: "array", items: { type: "string" } }, urls: { type: "array", items: { type: "string" } }, maxVideos: { type: "number" } }, required: ["provider"] } },
